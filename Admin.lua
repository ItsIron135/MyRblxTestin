...
-- ROCKET SPAM & DESYNC
---------------------------------------------------------
local ROCKET_MULTIPLIER = 2 -- How many times to fire PER launcher, PER frame. (Increase if you want it even faster!)
...
createToggle(0, -300, "Perm Desync", Color3.fromRGB(40,100,150), false, function()
    ...
    do
        local lockCF = root.CFrame
        local bg = set(Instance.new("BodyGyro", root), {
            MaxTorque = Vector3.new(9e9, 9e9, 9e9),
            P = 9e7,
            D = 100,
            CFrame = lockCF
        })
        local bpos = set(Instance.new("BodyPosition", root), {
            MaxForce = Vector3.new(9e9, 9e9, 9e9),
            P = 9e7,
            D = 200,
            Position = lockCF.Position
        })
